              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 pl-2 border-l border-zinc-200 dark:border-zinc-800">
                  ...
                  <div className="relative group">
                    ...
                    {/* Dropdown Menu nhỏ */}
                    <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-xl py-2 hidden group-hover:block transition-all text-zinc-700 dark:text-zinc-200 before:content-[''] before:absolute before:-top-2 before:left-0 before:right-0 before:h-2">
